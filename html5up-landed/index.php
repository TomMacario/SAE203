						...
						<div class="col-4 col-12-medium">
							...
							<ul class="actions">
								...
								if (isset($_SESSION["loggedin"])) {
									echo '<li><a href="no-sidebar.php" class="button">Learn More</a></li>';
								} else {
									echo '<li><a href="login.php" class="button">Learn More</a></li>';
								}
								?>
							</ul>
						</div>
		...
		<section id="two" class="spotlight style2 right">
			...
			<div class="content">
				...
				<ul class="actions">
					<?php
					if (isset($_SESSION["loggedin"])) {
					echo '<li><a href="right-sidebar.php" class="button">Learn More</a></li>';
					} else {
					echo '<li><a href="login.php" class="button">Learn More</a></li>';
					}
					?>
